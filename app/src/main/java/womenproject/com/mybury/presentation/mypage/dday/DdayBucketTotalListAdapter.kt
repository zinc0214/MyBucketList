...
class DdayBucketTotalListAdapter(context: Context?, val bucketList: List<DdayBucketList>,
                                 private val showSnackBar: ((BucketItem) -> Unit)) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        currentViewHolderTotal = DdayBucketTotalListViewHolder(
                DdayBucketListBinding.inflate(LayoutInflater.from(parent.context), parent, false), showSnackBar)
