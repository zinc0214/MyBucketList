...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CardView> {
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            finalSize = context.getResources().getDimensionPixelSize(R.dimen.image_final_width);
    ...
    private void maybeInitProperties(CardView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + ((int) mCustomFinalHeight / 2) + 50;
